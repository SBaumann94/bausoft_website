...
class Tortenet extends Component {
    render() {
        ...
        <div className="Tortenet pl3 overflow-x-hidden">
            ...
            automatikusan átvehetők a határoló
            szerkezetek adatai a hőszükséglet és nyári
            hőterhelés számításhoz.</p>
            ...
            ami a romániai előírásokat is követi,
            másrészt a felhasználók előtt megnyílt a
            lehetőség, hogy a dokumentálást más nyelven
            ...
            <p>A Hajdúsági Iparművek RT. számára a
            szükséges melegvíztermelő és tároló
            méretének meghatározását, a
            melegvíztermelő választékuk kiválasztását
            segítő programot készítéttünk, ami szintén
            ingyenesen szerezhető be tőlük. </p>

            <h3>2002</h3>
            <p>Az év elején a POLIFOAM Műanyagfeldolgozó
            Kft. számára készítettünk a szigetelések
            kiválasztására, méretezésére szolgáló
            programot, ami ingyenesen hozzáférhető rajtuk
            keresztül. Bővült az épületfizikai illetve
            radiátor-kiválasztással kiegészített céges
            programok sora. A BAUMIT Kft., a Villas Hungária
            Kft., az YTONG Hungary Kft. és a Zehnder
            Hungária Kft. jelentkezett új cégként, de
            ...
            változattal egyenértékű, adatbázisa
            természetesen a Danfoss termékeket helyezi
            előtérbe.</p>
            ...
            a programjainkkal kapcsolatos konzultációra,
            és a jövőben tovább kívánjuk szélesíteni
            oktatási programunkat.</p>

            <h3>2000</h3>
            <p>Az év elején, a Grundfos Hungária Kft.
            számára készült el, és került fel, az Ő
            több ezer példányban kiosztott CD-jükre a
            WinPipe hálózat méretező program. A program
            segítségével feldolgozhatók nem hurkolt
            fűtési és vízellátó rendszerek is.
            ...
            programok sorába. A Buderus Hungária
            Fűtestechnikai Kft, a Magyar Rézpiaci Központ,
            az LB-KNAUF és a DUNAFERR Lemezalakító Kft.
            Radiátor üzletága.</p>
            ...
            energetikai ellenőrzést teszi lehetővé.</p>

            <h3>1996</h3>
            <p>Ismét egy gyártó, a csongrádi PANOL RT
            számára végeztünk programfejlesztést, megint
            egy kicsit más terület következett,
            nevezetesen a hűtés. Az általuk gyártott és
            forgalmazott UTK jelü központi
            klímaberendezés kiválasztását,
            méretezését és ajánlati szintű
            dokumentálását tűzték ki feladatul. </p>

            <h3>1995</h3>
            <p>Elkészült a KOMPLEX fűtési rendszer
            hőtechnikai és hidraulikai méretező program,
            ami hagyományainkhoz híven szintén
            ...
            kifejlesztett épületfizikai számítások modul
            az épületgépész tervezők mellett az
            építész tervezők figyelmére is számot
            tarthat.</p>
            ...
            készítsünk. Így készítettünk először a
            Zehnder Hungária Kft. számára egy fűtési
            hőszükséglet számító és radiátor
            kiválasztó programot. Ezután a Laing
            Szivattyú Kft. és velük párhuzamosan a
            Danfoss Kft. számára készült el egy-egy
            egymásra sokban hasonlító program, ami a
            tervezési folyamatnak nem csak egy részletére,
            hanem a hőszükséglet számítástól indulva,
            radiátor kiválasztáson és padlófűtés
            méretezésen át a teljes hidraulikai rendszer
            méretezését tette már lehetővé. </p>

            <h3>1991-92</h3>
            <p>Családi vállalkozásként létrejött a
            BAUSOFT Pécsvárad Bt. Elsősorban az
            épületgépészeti témájú
            programfejlesztést, az ahhoz kapcsolódó
            szolgáltatásokat illetve az építőipari
            tervezést jelöltük ki magunknak tevékenységi
            körként.</p>
            <p>A fűtéstechnika területén, PC-n DOS alatt
            futtatható, a műszaki számításokat segítő
            programok készítésével kezdtük.
            Elkészítettük a fűtés tervezés alapjának
            tekinthető hőszükséglet számító
            programunkat a leggyakoribb radiátoros
            fűtéshez szükséges radiátor
            kiválasztással, ezt követte a hidraulikai
            méretezésre szolgáló kétcsöves fűtés
            hidraulikai méretező program. Sorrendben ezek
            után a fűtéstechnikai hőcserélők
            méretezése, az egycsöves fűtés méretezés
            majd a padlófűtés méretező program
            következett. Az eddigi programokra jellemző,
            hogy azok gyártó cégektől függetlenek, a
            bennük szereplő radiátorok, csövek, szelepek,
            szerelvények, padlófűtés rendszerek adatai a
            felhasználó által karbantarthatók, az
            adatbázis bővíthető.</p>        
            </div>
        );
    }
}
