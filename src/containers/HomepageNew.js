        ...
        return (
            <div className="pl3 HomePageNew">
                ...
                <Grid container spacing={0} className="pl1">
                    <Grid item xs={6} md={2}><SLink to="Bemutat" containerId="containerElement" className="MyButton">Bemutatkozás</SLink></Grid>
                    <Grid item xs={6} md={2}><SLink to="Prog" containerId="containerElement" className="MyButton">Programjaink</SLink></Grid>
                    <Grid item xs={6} md={2}><SLink to="WW" containerId="containerElement" className="MyButton">WinWatt</SLink></Grid>
                    <Grid item xs={6} md={2}><SLink to="Recommend" containerId="containerElement" className="MyButton">Ajánljuk még</SLink></Grid>
                </Grid>
                <div className="HomeSection" id="containerElement">
                    <Element name="Bemutat">
                        <Grid container spacing={0} className="Bemutat">
                        ...
                        <Grid container spacing={1} className="Programok">
